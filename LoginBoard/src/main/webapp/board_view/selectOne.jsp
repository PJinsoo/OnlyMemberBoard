		...
		<table border="1">
			...
			<tr>
				<td colspan="4" align="right">
					<input type="button" value="수정" onclick="location.href='board.do?command=boardUpdate&boardNo=${dto.boardNo }'">
					<input type="button" value="삭제" onclick="location.href='board.do?command=boardDelete&boardNo=${dto.boardNo }'">
